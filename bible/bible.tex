...
%%%---> That's for mindmap full screen
%\margins{.001in}{.001in}{115pt}{.001in}
...
1/.style={minimum width=#1},
column 2/.style={minimum
width=#2}]}
%    column 3/.style={minimum
%    width=#3},
%   column 4/.style={minimum
%   width=#4}]}%
{;\end{tikzpicture}}
%%%---> Tikz Box create --------------------------------------------------
\newlength{\boxw}
